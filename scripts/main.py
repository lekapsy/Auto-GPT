...
def print_assistant_thoughts(assistant_reply):
    ...
    try:
        ...
        assistant_reply_json = assistant_reply_yaml
    ...
    try:
        ...
        if isinstance(assistant_reply_json, str):
            try:
                assistant_reply_json = yaml.load(assistant_reply_json)
            except json.JSONDecodeError as e:
                print_to_console("Error: Invalid Yaml\n", Fore.RED, assistant_reply)
    ...
    if not cfg.continuous_mode and next_action_count == 0:
        ...
        while True:
            ...
            if console_input.lower() == "y":
                user_input = "GENERATE NEXT COMMAND YAML"
                break
        ...
        if user_input == "GENERATE NEXT COMMAND YAML":
            print_to_console(
